...
CREATE VIEW "public"."notes_live" AS (select "id", "kind", "title", "body", "conditions", "previous_subjects", "sort_at", "position", "recipe_id", "revision_id", "step_id", "ingredient_id", "experiment_id", "created_at", "updated_at", "deleted_at", "deleted_by", "deleted_reason", "deleted_event_id" from "notes" where "notes"."deleted_at" is null);--> statement-breakpoint
